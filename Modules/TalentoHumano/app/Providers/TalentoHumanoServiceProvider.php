...
namespace Modules\TalentoHumano\App\Providers;

use Illuminate\Support\Facades\Blade;
use Illuminate\Support\ServiceProvider;
use Livewire\Livewire;
use Modules\TalentoHumano\App\Livewire\AcademicInfoManager;
use Modules\Talentohumano\App\Livewire\ContractManager;
...
class TalentoHumanoServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'TalentoHumano';

    protected string $nameLower = 'talentohumano';
