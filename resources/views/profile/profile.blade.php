                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <div class="profile-img position-relative me-3 mb-3 mb-lg-0 profile-logo profile-logo1">
                                ...
                                <img src="../assets/images/avatars/02.png" alt="User-Profile" class="theme-color-purple-img img-fluid rounded-pill avatar-100" loading="lazy">
                                <img src="../assets/images/avatars/03.png" alt="User-Profile" class="theme-color-blue-img img-fluid rounded-pill avatar-100" loading="lazy">
                                ...
                                <img src="../assets/images/avatars/06.png" alt="User-Profile" class="theme-color-pink-img img-fluid rounded-pill avatar-100" loading="lazy">
                            </div>
                ...
                <div class="card-body">
                    <div class="d-grid gap-card grid-cols-3">
                        <a data-fslightbox="gallery" href="../assets/images/icons/04.png">
                            <img src="../assets/images/icons/04.png" class="img-fluid bg-info-subtle  rounded" alt="profile-image" loading="lazy">
                        </a>
                        <a data-fslightbox="gallery" href="../assets/images/shapes/02.png">
                            <img src="../assets/images/shapes/02.png" class="img-fluid bg-primary-subtle rounded" alt="profile-image" loading="lazy">
                        </a>
                        <a data-fslightbox="gallery" href="../assets/images/icons/08.png">
                            <img src="../assets/images/icons/08.png" class="img-fluid bg-info-subtle rounded" alt="profile-image" loading="lazy">
                        </a>
                        <a data-fslightbox="gallery" href="../assets/images/shapes/04.png">
                            <img src="../assets/images/shapes/04.png" class="img-fluid bg-primary-subtle rounded" alt="profile-image" loading="lazy">
                        </a>
                        <a data-fslightbox="gallery" href="../assets/images/shapes/03.png">
                            <img src="../assets/images/shapes/03.png" class="img-fluid bg-warning-subtle rounded" alt="profile-image" loading="lazy">
                        </a>
                        <a data-fslightbox="gallery" href="../assets/images/shapes/06.png">
                            <img src="../assets/images/shapes/06.png" class="img-fluid bg-primary-subtle rounded" alt="profile-image" loading="lazy">
                        </a>
                        <a data-fslightbox="gallery" href="../assets/images/shapes/05.png">
                            <img src="../assets/images/shapes/05.png" class="img-fluid bg-danger-subtle rounded" alt="profile-image" loading="lazy">
                        </a>
                        <a data-fslightbox="gallery" href="../assets/images/shapes/08.png">
                            <img src="../assets/images/shapes/04.png" class="img-fluid bg-primary-subtle rounded" alt="profile-image" loading="lazy">
                        </a>
                        <a data-fslightbox="gallery" href="../assets/images/icons/01.png">
                            <img src="../assets/images/icons/01.png" class="img-fluid bg-success-subtle rounded" alt="profile-image" loading="lazy">
                        </a>
                    </div>
                </div>
                </div>
                ...
                <div class="card-body">
                    <div class="twit-feed">
                        <div class="d-flex align-items-center mb-2">
                            <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-danger-subtle ps-2" src="../assets/images/avatars/03.png" alt="" loading="lazy">
                    ...
                    <div class="twit-feed">
                        <div class="d-flex align-items-center mb-2">
                            <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-primary-subtle" src="../assets/images/avatars/04.png" alt="" loading="lazy">
                            <div class="media-support-info">
                    ...
                    <div class="twit-feed">
                        <div class="d-flex align-items-center mb-2">
                            <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-warning-subtle  pt-2" src="../assets/images/avatars/02.png" alt="" loading="lazy">
                            <div class="mt-2">
                ...
                <div id="profile-feed" class="tab-pane fade active show">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between pb-4">
                            ...
                            <div class="d-flex flex-wrap">
                                <div class="media-support-user-img me-3">
                                    <img class="rounded-pill img-fluid avatar-60 bg-danger-subtle p-1" src="../assets/images/avatars/02.png" alt="" loading="lazy">
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="user-post">
                            <a href="javascript:void(0);"><img src="../assets/images/pages/03-page.jpg" alt="post-image" class="img-fluid" loading="lazy"></a>
                            </div>
            ...
            <div class="col-lg-3">
                ...
                <div class="card-body">
                    <ul class="list-inline m-0 p-0">
                        <li class="d-flex mb-4 align-items-center active">
                            <img src="../assets/images/shapes/02.png" alt="story-img" class="rounded-pill avatar-70 p-1 border bg-light-subtle img-fluid" loading="lazy">
                            <div class="ms-3">
                            <h5>Web Design</h5>
                        ...
                        <li class="d-flex mb-4 align-items-center">
                            <img src="../assets/images/shapes/04.png" alt="story-img" class="rounded-pill avatar-70 p-1 border img-fluid bg-danger-subtle " loading="lazy">
                            <div class="ms-3">
                            <h5>App Design</h5>
                        ...
                        <li class="d-flex align-items-center">
                            <img src="../assets/images/shapes/06.png" alt="story-img" class="rounded-pill avatar-70 p-1 border bg-primary-subtle img-fluid" loading="lazy">
                            <div class="ms-3">
                ...
                <div class="card-body">
                    <ul class="list-inline m-0 p-0">
                        ...
                        <li class="d-flex mb-4 align-items-center">
                            <div class="img-fluid bg-success-subtle rounded-pill"><img src="../assets/images/avatars/08.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                            <div class="ms-3 flex-grow-1">
                            <h6>Guy Hawkins</h6>
