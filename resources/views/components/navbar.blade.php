<nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
    <div class="container-fluid navbar-inner">
        <a href="{{ route('dashboard') }}" class="navbar-brand">            
            ...
            <!--logo End-->         
            <h4 class="logo-title d-block d-xl-none" data-setting="app_name">{{ config('app.name') }}</h4>
        </a>
                            ...
                            <ul class="iq-header-sub-menu list-unstyled collapse" id="allPagesData">
                                <li class="nav-item">
                                    ...
                                    <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="specialPages">
                                        ...
                                        {{-- <li class="nav-item"><a class="nav-link " href="./special-pages/calendar.html">Calendar</a></li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="iq-header-sub-menu list-unstyled collapse" id="elementsData">
                                ...
                                <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="ui-element">
                                    <li class="nav-item"><a class="nav-link " href="#">Avatars</a></li>
                            ...
                            <li class="nav-item">
                                ...
                                <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="widgetsPage">
                                    <li class="nav-item"><a class="nav-link " href="#">Widget Basic</a></li>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item dropdown">
                <a class="py-0 nav-link d-flex align-items-center ps-3" href="#" id="profile-setting" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ asset('assets/images/avatars/default-avatar.png')}}" alt="User-Profile" class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded" loading="lazy">
                ...
                <ul class="dropdown-menu dropdown-menu-end custom-drop-mode2" aria-labelledby="profile-setting">
