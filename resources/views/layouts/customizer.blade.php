...
<div class="offcanvas offcanvas-end live-customizer" tabindex="-1" id="live-customizer" data-bs-backdrop="false" data-bs-scroll="true" aria-labelledby="live-customizer-label" aria-modal="true" role="dialog">
    <div class="offcanvas-header pb-0">
        <div class="d-flex align-items-center">
            <h4 class="offcanvas-title" id="live-customizer-label">{{ __('Setting Pannel') }}</h4>
        </div>
            ...
            <div class="col-lg-12">
                <div>
                    <div class="text-center mb-4">
                        <h5 class="d-inline-block">{{ __('Style Setting') }}</h5>
                    </div>
                    <div>
                        <!-- Theme start here -->
                        <div class="mb-4">
                            <h5 class="mb-3">{{ __('Theme') }}</h5>
                            <div class=" mb-3" data-setting="radio">
                                <div class="form-check mb-0 w-100">
                                    <input class="form-check-input custom-redio-btn mt-2" type="radio" value="light" name="theme_scheme" id="color-mode-light" checked="">
                            ...
                            <div class=" mb-3" data-setting="radio">
                                <div class="form-check mb-0 w-100 ">
                                    <input class="form-check-input custom-redio-btn mt-2" type="radio" value="dark" name="theme_scheme" id="color-mode-dark">
                            ...
                            <div class="d-flex align-items-center justify-content-between" data-setting="radio">
                                <div class="form-check mb-0 w-100">
                                    <input class="form-check-input custom-redio-btn mt-2" type="radio" value="auto" name="theme_scheme" id="color-mode-auto">
                                    <label class="form-check-label d-flex align-items-center justify-content-between" for="color-mode-auto">
                                        <span>{{ __('Device Default') }}</span> 
                                        <div class="text-primary ">
                        ...
                        <div class="mb-4">
                            <h5 class="mt-4 mb-3">{{ __('Active Menu Style') }}</h5>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <h6 class="mt-4 mb-3">{{ __('Color Customizer') }}</h6>
                            <div class="d-flex align-items-center">
                                <a href="#custom-color" data-bs-toggle="collapse" role="button"
                                    aria-expanded="false" aria-controls="custom-color">{{ __('Custom') }}</a>
                                <div data-setting="radio">
                        ...
                        <div class="collapse" id="custom-color">
                            ...
                            <div class="form-group d-flex d-flex justify-content-between align-items-center">
                                ...
                                <input class="" name="theme_color" data-extra="secondary" type="color"
                                    id="custom-secondary-color" value="#00C3F9" data-setting="color">
                            </div>
                            <div class="form-group d-flex d-flex justify-content-between align-items-center">
                        ...
                        <hr class="hr-horizontal">
                        <div>
                        <h6 class="d-inline-block mb-3 me-2">{{ __('Page Style') }} </h6>
                        <div class="d-grid gap-3 grid-cols-2 mb-4">
                            <div data-setting="radio">
                            <input type="radio" value="container" class="btn-check" name="page_layout" id="page-layout-boxed">
                            <label class="btn btn-border d-block" for="page-layout-boxed">{{ __('Boxed') }}</label>
                            </div>
                            <div data-setting="radio">
                            <input type="radio" value="container-fluid" class="btn-check" name="page_layout" id="page-layout-full-width" checked="">
                            <label class="btn btn-border d-block" for="page-layout-full-width">{{ __('Full Width') }}</label>
                            </div>
                        </div>
                        </div>
                        <hr class="hr-horizontal">
                        ...
                        <div>
                            <h5 class="mb-3 mt-4">{{ __('Direction') }}</h5>
                            <div class=" mb-3" data-setting="radio">
                                <div class="form-check mb-0 w-100">
