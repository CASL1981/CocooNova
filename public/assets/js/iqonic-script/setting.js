 ...
 * ***********************/
 ...
 (function (window) {
  ...
  // 4. theme_font_size function to the IQSetting prototype @params: value (string)
  ...
  // 5. sidebar_color function to the IQSetting prototype @params: value (string)
  ...
  // 7. sidebar_type function to the IQSetting prototype @params: value (string)
  IQSetting.prototype.sidebar_type = function (value, currentValue) {
    if (value !== null) {
      this.__checkboxUpdate__("sidebar_type", value, currentValue);
    }
  };
  //8. sidebar_menu_style function to the IQSetting prototype @params: value (string)
